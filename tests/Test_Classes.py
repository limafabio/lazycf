...
from sample.TestProblem import TestProblem
...
class TestClasses(unittest.TestCase):
    ...
    def test_testproblem_init(self):
        testproblem_test = TestProblem('input', 'output')
        self.assertEqual(str(testproblem_test.__class__),
                         "sample.TestProblem.TestProblem")
